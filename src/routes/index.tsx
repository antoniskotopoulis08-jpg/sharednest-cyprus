...
const FEATURED: LuxeCardData[] = [
  {
    ...
    category: "invest",
    availableSharePct: 62,
    yearlyRentalFullPct: 6.2,
    occupancyPct: 82,
    riskLevel: "Medium",
    mgmtFeePct: 12,
    rentalDemand: "Very strong",
    capitalGrowth: "Strong",
    beachKm: 0.1,
    centerKm: 0.8,
    schoolKm: 1.6,
    lifestyleScore: 94,
    familySuitability: "All ages",
  },
  {
    id: "paf-01",
    ...
    mgmtFeePct: 14,
    rentalDemand: "Strong",
    capitalGrowth: "Moderate",
    beachKm: 1.4,
    centerKm: 3.2,
    schoolKm: 2.4,
    lifestyleScore: 89,
    familySuitability: "Young families",
  },
  {
    id: "lar-01",
    ...
    category: "residency",
    availableSharePct: 78,
    yearlyRentalFullPct: 4.8,
    occupancyPct: 68,
    riskLevel: "Low",
    mgmtFeePct: 10,
    rentalDemand: "Steady",
    capitalGrowth: "Stable",
    beachKm: 0.5,
    centerKm: 0.4,
    schoolKm: 0.9,
    lifestyleScore: 86,
...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-[oklch(0.11_0.035_150)] text-white">
      ...
      <div className="relative container-page pt-6 pb-14 md:pt-8 md:pb-18">
